...
: Node("armor_detector", options)
{
  ...
  target_color_sub_ = this->create_subscription<auto_aim_interfaces::msg::TargetColor>("/target_color", 
  rclcpp::SensorDataQoS(),std::bind(&ArmorDetectorNode::targetColorCallback, this, std::placeholders::_1));
...
void ArmorDetectorNode::targetColorCallback(const auto_aim_interfaces::msg::TargetColor & msg)
{
