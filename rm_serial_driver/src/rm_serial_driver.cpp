  ...
  serial_driver_{new drivers::serial_driver::SerialDriver(*owned_ctx_)}
{
  ...
  target_color_pub_ = this->create_publisher<auto_aim_interfaces::msg::TargetColor>("/target_color", 10);
    ...
    try {
      ...
      if (header[0] == 0x5A) {
        ...
        if (crc_ok) {
          ...
          auto_aim_interfaces::msg::TargetColor tar_color;
          ...
          tar_color.target_color = packet.robot_color;
          target_color_pub_->publish(tar_color);
